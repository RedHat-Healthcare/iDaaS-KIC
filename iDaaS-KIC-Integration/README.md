...
1. Have the database setup and configured. The sample properties are in the Design Pattern/Accelerator Configuration section below.
...
This implementation is processing all the data from the topic named opmgmt_transactions.
...
4. If the correct properties are set you will also have the data from the topics written out as JSON files.   
